...
<head>
    ...
    <link rel="stylesheet" href="/css/huaye/cloud.css">
    ...
    <div class="main">
        ...
        <div class="product-pic">
            ...
            <div class="pro-con">
                <ul>
                    <li>
                        <img src="../images/huaye/cloud_pro_1.jpg" class="shadow" alt="">
                    </li>
                    <li>
                        <img src="../images/huaye/cloud_pro_2.jpg" class="shadow" alt="">
                    </li>
                </ul>
            </div>
        </div>
